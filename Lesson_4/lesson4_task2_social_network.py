...
module re - regular expressions library which I use in _reg_password validation
module yaml - for pretty print of my dictionaries
...
class DatabaseSingleton:
    ...
    def add_post(self, login, post_body):
        self._post_id += 1
        self._posts_dict[self._post_id] = {
            "login": login,
            "post": post_body,
